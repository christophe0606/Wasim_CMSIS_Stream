...
#define SAM_INTERNAL_ID 35
#define DUP0_INTERNAL_ID 51
#define DUP1_INTERNAL_ID 52
#define DUP10_INTERNAL_ID 53
#define DUP11_INTERNAL_ID 54
#define DUP12_INTERNAL_ID 55
#define DUP13_INTERNAL_ID 56
#define DUP14_INTERNAL_ID 57
#define DUP15_INTERNAL_ID 58
#define DUP2_INTERNAL_ID 59
#define DUP3_INTERNAL_ID 60
#define DUP4_INTERNAL_ID 61
#define DUP5_INTERNAL_ID 62
#define DUP6_INTERNAL_ID 63
#define DUP7_INTERNAL_ID 64
#define DUP8_INTERNAL_ID 65
#define DUP9_INTERNAL_ID 66
...
#define FIFOSIZE47 64
#define FIFOSIZE48 64
#define FIFOSIZE49 1
#define FIFOSIZE50 1
#define FIFOSIZE51 1
#define FIFOSIZE52 1
...
#define BUFFERSIZE19 16
CG_BEFORE_BUFFER
uint8_t buf19[BUFFERSIZE19]={0};
                              ...
                              int32_t *atomic)
{
    ...
    */
    ...
    FIFO<float,FIFOSIZE1,1,0> fifo1(buf18);
    FIFO<float,FIFOSIZE2,1,0> fifo2(buf18);
    FIFO<float,FIFOSIZE3,1,0> fifo3(buf16);
    FIFO<float,FIFOSIZE4,1,0> fifo4(buf13);
    FIFO<float,FIFOSIZE5,1,0> fifo5(buf14);
    FIFO<float,FIFOSIZE6,1,0> fifo6(buf14);
    FIFO<float,FIFOSIZE7,1,0> fifo7(buf9);
    FIFO<float,FIFOSIZE8,1,0> fifo8(buf8);
    FIFO<float,FIFOSIZE9,1,0> fifo9(buf5);
    FIFO<float,FIFOSIZE10,1,0> fifo10(buf4);
    FIFO<float,FIFOSIZE11,1,0> fifo11(buf18);
    FIFO<float,FIFOSIZE12,1,0> fifo12(buf18);
    FIFO<float,FIFOSIZE13,1,0> fifo13(buf18);
    FIFO<float,FIFOSIZE14,1,0> fifo14(buf6);
    FIFO<float,FIFOSIZE15,1,0> fifo15(buf11);
    FIFO<float,FIFOSIZE16,1,0> fifo16(buf2);
    FIFO<float,FIFOSIZE17,1,0> fifo17(buf15);
    FIFO<float,FIFOSIZE18,1,0> fifo18(buf17);
    FIFO<float,FIFOSIZE19,1,0> fifo19(buf12);
    FIFO<float,FIFOSIZE20,1,0> fifo20(buf14);
    FIFO<float,FIFOSIZE21,1,0> fifo21(buf16);
    FIFO<float,FIFOSIZE22,1,0> fifo22(buf15);
    FIFO<float,FIFOSIZE23,1,0> fifo23(buf10);
    FIFO<float,FIFOSIZE24,1,0> fifo24(buf7);
    FIFO<float,FIFOSIZE25,1,0> fifo25(buf17);
    FIFO<float,FIFOSIZE26,1,0> fifo26(buf18);
    FIFO<float,FIFOSIZE27,1,0> fifo27(buf5);
    FIFO<float,FIFOSIZE28,1,0> fifo28(buf11);
    FIFO<float,FIFOSIZE29,1,0> fifo29(buf9);
    FIFO<float,FIFOSIZE30,1,0> fifo30(buf7);
    FIFO<float,FIFOSIZE31,1,0> fifo31(buf14);
    FIFO<float,FIFOSIZE32,1,0> fifo32(buf15);
    FIFO<float,FIFOSIZE33,1,0> fifo33(buf10);
    FIFO<float,FIFOSIZE34,1,0> fifo34(buf12);
    FIFO<float,FIFOSIZE35,1,0> fifo35(buf13);
    FIFO<float,FIFOSIZE36,1,0> fifo36(buf14);
    FIFO<float,FIFOSIZE37,1,0> fifo37(buf7);
    FIFO<float,FIFOSIZE38,1,0> fifo38(buf6);
    FIFO<float,FIFOSIZE39,1,0> fifo39(buf3);
    FIFO<float,FIFOSIZE40,1,0> fifo40(buf6);
    FIFO<float,FIFOSIZE41,1,0> fifo41(buf2);
    FIFO<float,FIFOSIZE42,1,0> fifo42(buf1);
    FIFO<float,FIFOSIZE43,1,0> fifo43(buf4);
    FIFO<float,FIFOSIZE44,1,0> fifo44(buf3);
    FIFO<float,FIFOSIZE45,1,0> fifo45(buf8);
    FIFO<float,FIFOSIZE46,1,0> fifo46(buf1);
    FIFO<float,FIFOSIZE47,1,0> fifo47(buf5);
    FIFO<float,FIFOSIZE48,1,0> fifo48(buf2);
    FIFO<midi_cmd_t,FIFOSIZE49,1,0> fifo49(buf15);
    FIFO<midi_cmd_t,FIFOSIZE50,1,0> fifo50(buf15);
    FIFO<midi_cmd_t,FIFOSIZE51,1,0> fifo51(buf19);
    FIFO<midi_cmd_t,FIFOSIZE52,1,0> fifo52(buf14);
    FIFO<midi_cmd_t,FIFOSIZE53,1,0> fifo53(buf14);
    FIFO<midi_cmd_t,FIFOSIZE54,1,0> fifo54(buf19);
    FIFO<midi_cmd_t,FIFOSIZE55,1,0> fifo55(buf16);
    FIFO<midi_cmd_t,FIFOSIZE56,1,0> fifo56(buf17);
    FIFO<midi_cmd_t,FIFOSIZE57,1,0> fifo57(buf18);
    FIFO<midi_cmd_t,FIFOSIZE58,1,0> fifo58(buf13);
    FIFO<midi_cmd_t,FIFOSIZE59,1,0> fifo59(buf15);
    FIFO<midi_cmd_t,FIFOSIZE60,1,0> fifo60(buf17);
    FIFO<midi_cmd_t,FIFOSIZE61,1,0> fifo61(buf12);
    FIFO<midi_cmd_t,FIFOSIZE62,1,0> fifo62(buf12);
    FIFO<midi_cmd_t,FIFOSIZE63,1,0> fifo63(buf15);
    FIFO<midi_cmd_t,FIFOSIZE64,1,0> fifo64(buf10);
    FIFO<midi_cmd_t,FIFOSIZE65,1,0> fifo65(buf10);
    FIFO<midi_cmd_t,FIFOSIZE66,1,0> fifo66(buf15);
    FIFO<midi_cmd_t,FIFOSIZE67,1,0> fifo67(buf9);
    FIFO<midi_cmd_t,FIFOSIZE68,1,0> fifo68(buf14);
    FIFO<midi_cmd_t,FIFOSIZE69,1,0> fifo69(buf15);
    FIFO<midi_cmd_t,FIFOSIZE70,1,0> fifo70(buf8);
    FIFO<midi_cmd_t,FIFOSIZE71,1,0> fifo71(buf12);
    FIFO<midi_cmd_t,FIFOSIZE72,1,0> fifo72(buf14);
    FIFO<midi_cmd_t,FIFOSIZE73,1,0> fifo73(buf5);
    FIFO<midi_cmd_t,FIFOSIZE74,1,0> fifo74(buf10);
    FIFO<midi_cmd_t,FIFOSIZE75,1,0> fifo75(buf12);
    FIFO<midi_cmd_t,FIFOSIZE76,1,0> fifo76(buf4);
    FIFO<midi_cmd_t,FIFOSIZE77,1,0> fifo77(buf7);
    FIFO<midi_cmd_t,FIFOSIZE78,1,0> fifo78(buf9);
    FIFO<midi_cmd_t,FIFOSIZE79,1,0> fifo79(buf7);
    FIFO<midi_cmd_t,FIFOSIZE80,1,0> fifo80(buf7);
    FIFO<midi_cmd_t,FIFOSIZE81,1,0> fifo81(buf19);
    FIFO<midi_cmd_t,FIFOSIZE82,1,0> fifo82(buf6);
    FIFO<midi_cmd_t,FIFOSIZE83,1,0> fifo83(buf6);
    FIFO<midi_cmd_t,FIFOSIZE84,1,0> fifo84(buf19);
    FIFO<midi_cmd_t,FIFOSIZE85,1,0> fifo85(buf17);
    FIFO<midi_cmd_t,FIFOSIZE86,1,0> fifo86(buf17);
    FIFO<midi_cmd_t,FIFOSIZE87,1,0> fifo87(buf19);
    FIFO<midi_cmd_t,FIFOSIZE88,1,0> fifo88(buf3);
    FIFO<midi_cmd_t,FIFOSIZE89,1,0> fifo89(buf3);
    FIFO<midi_cmd_t,FIFOSIZE90,1,0> fifo90(buf7);
    FIFO<midi_cmd_t,FIFOSIZE91,1,0> fifo91(buf11);
    FIFO<midi_cmd_t,FIFOSIZE92,1,0> fifo92(buf18);
    FIFO<midi_cmd_t,FIFOSIZE93,1,0> fifo93(buf19);
    FIFO<midi_cmd_t,FIFOSIZE94,1,0> fifo94(buf2);
    FIFO<midi_cmd_t,FIFOSIZE95,1,0> fifo95(buf6);
    FIFO<midi_cmd_t,FIFOSIZE96,1,0> fifo96(buf7);

    CG_BEFORE_NODE_INIT;
    /* 
    Create node objects
    */
    WebAudioSink<float,64,float,64,float,1> Node_0(fifo47,fifo48,fifo0,output_queue,atomic); /* Node ID = 0 */
    NullSource<float,1> Node_1(fifo0); /* Node ID = 1 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_10(fifo60,fifo4,fifo32); /* Node ID = 2 */
    MIDIWav<midi_cmd_t,1,float,64> Node_11(fifo62,fifo5); /* Node ID = 3 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_12(fifo63,fifo5,fifo19); /* Node ID = 4 */
    MIDIWav<midi_cmd_t,1,float,64> Node_13(fifo65,fifo6); /* Node ID = 5 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_14(fifo66,fifo6,fifo33); /* Node ID = 6 */
    MIDIWav<midi_cmd_t,1,float,64> Node_15(fifo68,fifo7); /* Node ID = 7 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_16(fifo69,fifo7,fifo20); /* Node ID = 8 */
    MIDIWav<midi_cmd_t,1,float,64> Node_17(fifo71,fifo8); /* Node ID = 9 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_18(fifo72,fifo8,fifo34); /* Node ID = 10 */
    MIDIWav<midi_cmd_t,1,float,64> Node_19(fifo74,fifo9); /* Node ID = 11 */
    MIDISeq<midi_cmd_t,1> Node_2({&fifo52,&fifo55,&fifo58,&fifo61,&fifo64,&fifo67,&fifo70,&fifo73,&fifo76,&fifo79,&fifo82,&fifo85,&fifo88,&fifo91,&fifo94},(char*)txt,empire); /* Node ID = 12 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_20(fifo75,fifo9,fifo23); /* Node ID = 13 */
    MIDIWav<midi_cmd_t,1,float,64> Node_21(fifo77,fifo10); /* Node ID = 14 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_22(fifo78,fifo10,fifo37); /* Node ID = 15 */
    MIDIWav<midi_cmd_t,1,float,64> Node_23(fifo80,fifo11); /* Node ID = 16 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_24(fifo81,fifo11,fifo24); /* Node ID = 17 */
    MIDIWav<midi_cmd_t,1,float,64> Node_25(fifo83,fifo12); /* Node ID = 18 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_26(fifo84,fifo12,fifo38); /* Node ID = 19 */
    MIDIWav<midi_cmd_t,1,float,64> Node_27(fifo86,fifo13); /* Node ID = 20 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_28(fifo87,fifo13,fifo25); /* Node ID = 21 */
    MIDIWav<midi_cmd_t,1,float,64> Node_29(fifo89,fifo14); /* Node ID = 22 */
    MIDIWav<midi_cmd_t,1,float,64> Node_3(fifo50,fifo1); /* Node ID = 23 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_30(fifo90,fifo14,fifo39); /* Node ID = 24 */
    MIDIWav<midi_cmd_t,1,float,64> Node_31(fifo92,fifo15); /* Node ID = 25 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_32(fifo93,fifo15,fifo26); /* Node ID = 26 */
    MIDIWav<midi_cmd_t,1,float,64> Node_33(fifo95,fifo16); /* Node ID = 27 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_34(fifo96,fifo16,fifo40); /* Node ID = 28 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_4(fifo51,fifo1,fifo17); /* Node ID = 29 */
    MIDIWav<midi_cmd_t,1,float,64> Node_5(fifo53,fifo2); /* Node ID = 30 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_6(fifo54,fifo2,fifo31); /* Node ID = 31 */
    MIDIWav<midi_cmd_t,1,float,64> Node_7(fifo56,fifo3); /* Node ID = 32 */
    MIDIEnv<midi_cmd_t,1,float,64,float,64> Node_8(fifo57,fifo3,fifo18); /* Node ID = 33 */
    MIDIWav<midi_cmd_t,1,float,64> Node_9(fifo59,fifo4); /* Node ID = 34 */
    Sam<float,64> SAM(fifo42,(char*)txt); /* Node ID = 35 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup0(fifo49,{&fifo51}); /* Node ID = 51 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup1(fifo52,{&fifo54}); /* Node ID = 52 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup10(fifo79,{&fifo81}); /* Node ID = 53 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup11(fifo82,{&fifo84}); /* Node ID = 54 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup12(fifo85,{&fifo87}); /* Node ID = 55 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup13(fifo88,{&fifo90}); /* Node ID = 56 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup14(fifo91,{&fifo92,&fifo93}); /* Node ID = 57 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup15(fifo94,{&fifo95,&fifo96}); /* Node ID = 58 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup2(fifo55,{&fifo56,&fifo57}); /* Node ID = 59 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup3(fifo58,{&fifo59,&fifo60}); /* Node ID = 60 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup4(fifo61,{&fifo63}); /* Node ID = 61 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup5(fifo64,{&fifo66}); /* Node ID = 62 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup6(fifo67,{&fifo68,&fifo69}); /* Node ID = 63 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup7(fifo70,{&fifo71,&fifo72}); /* Node ID = 64 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup8(fifo73,{&fifo74,&fifo75}); /* Node ID = 65 */
    Duplicate<midi_cmd_t,1,midi_cmd_t,1> dup9(fifo76,{&fifo77,&fifo78}); /* Node ID = 66 */
    ...
    while(cgStaticError==0)
    {
       ...
       CHECKERROR;
       CG_BEFORE_NODE_EXECUTION(65);
       cgStaticError = dup8.run();
       CG_AFTER_NODE_EXECUTION(65);
       CHECKERROR;
       ...
       CG_BEFORE_NODE_EXECUTION(36);
       
                  {
                   ...
                   o2=fifo47.getWriteBuffer(64);
                   arm_add_f32(i0,i1,o2,64);
                   cgStaticError = 0;
                  }
       CG_AFTER_NODE_EXECUTION(36);
       CHECKERROR;
       CG_BEFORE_NODE_EXECUTION(66);
       cgStaticError = dup9.run();
       CG_AFTER_NODE_EXECUTION(66);
       CHECKERROR;
       ...
       CG_BEFORE_NODE_EXECUTION(49);
       
                  {
                   ...
                   float* i1;
                   float* o2;
                   i0=fifo45.getReadBuffer(64);
                   i1=fifo46.getReadBuffer(64);
                   o2=fifo48.getWriteBuffer(64);
                   arm_add_f32(i0,i1,o2,64);
                   cgStaticError = 0;
                  }
